...
export default function ProjectModal({ project, onClose }: ProjectModalProps) {
  ...
  const labels = language === "th"
    ? {
        ...
        features: "รายละเอียดสำคัญ",
        download: "ดาวน์โหลด APK",
        demo: "ดูเว็บไซต์",
        source: "ดูซอร์สโค้ด",
        scan: "สแกนเพื่อดาวน์โหลด",
        scanDetail: "สแกน QR Code ด้วยมือถือเพื่อดาวน์โหลดไฟล์ติดตั้ง (.apk)",
        qrAlt: "QR Code สำหรับดาวน์โหลด APK",
      }
    : {
        ...
        scanDetail: "Scan this QR code on your phone to download the installation file (.apk).",
        qrAlt: "QR code to download APK",
      };
  ...
  return (
    <div className="ProjectModal-overlay" onClick={onClose}>
      <div className="ProjectModal-container" onClick={(e) => e.stopPropagation()}>
        <button className="ProjectModal-close" onClick={onClose} aria-label={labels.close}>
          &times;
        </button>
